 ...
 * 
 * - can be read freely
 * - can be modified only via controlled side-effecting actions
 *
 * The state can be passed freely to components:
 * - modules (e.g. help module) can use to produce some documentation or to change current working directory 
